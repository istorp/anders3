            ...
            try
            {
                ...
                while (!defeated)
                {
                    foreach (Character attacker in characters)
                    {
                        ...
                        {
                            int randaomSkill = new Random().Next(attacker.CharacterSkills.Count);
                            attackUsed = attacker.CharacterSkills[randaomSkill].Skill.Name;
                            damage = DoSkillAttack(attacker, opponent, attacker.CharacterSkills[randaomSkill]);
                        }
                        ...
                        if (opponent.HitPoints <= 0)
                        {
                            ...
                            response.Data.Log.Add($"{attacker.Name}  winns with {attacker.HitPoints} HP left!!");
                            break;
                        }
